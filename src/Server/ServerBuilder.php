...
class ServerBuilder
{
    ...
    public function __construct(private $credentialsProvider)
    {
    }
    ...
    public function build(): Server
    {
        ...
        $nonceValidator = $this->nonceValidator ?: new CallbackNonceValidator(fn(string $nonce, int $timestamp): bool => true);
    ...
    public static function create($credentialsProvider): static
    {
